...
const PlantCard: React.FC<PlantCardProps> = ({plant, onWater, onClick, onRemoved, showDead = false, hideDelete = false, hideWater = false}) => {
    ...
    return (
        <>
          ...
          bg-[var(--color-surface)] hover:shadow-md transition-shadow w-[clamp(10rem,14vw,18rem)] h-[clamp(14rem,20vw,22rem)]] p-fluid
          ${deadStyle}
        `}
            >
                {/* delete */}
                ...
                {/* footer */}
                <div className="flex items-center justify-between text-fluid mt-[clamp(0.5rem,1vw,1rem)]">
